  ...
  console.log("Our extention is loaded", videoUrls);

  var container = document.getElementById("watch8-secondary-actions");
  var btn = document.createElement("button");
  btn.className = "yt-uix-button yt-uix-button-size-default yt-uix-button-opacity yt-uix-button-has-icon no-icon-markup pause-resume-autoplay action-panel-trigger action-panel-trigger-download yt-uix-tooltip";
